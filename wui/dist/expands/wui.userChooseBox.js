...
;(function (ui,$, undefined){
     ...
     * <li>赋值、取值一个方法解决。 </li>
     * </ol>
     * <h3>预览地址：<a href="../../examples/index.html?isShowMenu=1&rootId=wuiUserChooseBox" target="_blank">demo</a></h3>
     * <h3 style="display:none">方法说明：</h3>
     * <ol style="display:none">
     * <li>{{#crossLink "wui.userChooseBox/init"}}{{/crossLink}}: 初始化 </li>
     ...
     * <li>{{#crossLink "wui.userChooseBox/destroy"}}{{/crossLink}}: 销毁组件 </li>
     * </ol>
     * @namespace wui
     * @class userChooseBox
     *  @constructor  
     ...
     *  @param {Object} [option.value=null]  默认值@@@###初始化完成时,默认选中数据
     *  @param {string} [option.name="id"] 关键字段@@@###选中值保存的name字段
     *  @param {string} [option.text="name"] 文本字段@@@###选中值保存的text字段,显示多个字段时,字段用"{{}}"包裹表示,其他字符串原样输出,比如: {{id}}-{{name}}
     *  @param {string} option.tabUrl 列表URL@@@###弹出层列表页面URL(假如是相对路径,那是相对于popPageUrl参数所在页面路径。多个数据用","分隔开)
     *  @param {string} [option.ellipsis="..."]   省略符号@@@###当标签个数达到最大字符数时替换多余字符的字符串
     ...
     *  @param {string} [option.popPageUrl]  弹窗页面URL@@@###弹出公共页面URL,默认是 wui.commonPageBasePath + "wui.userChooseBox.popup.html"
     ...
     *  @param {string} [option.treeUrl=wui.serviceInterface.orgServiceAPI]    弹出层树服务数据源
     ...
     *  @param {Function} [option.onEmpty] empty触发方法@@@###组件清空之后调用方法
     *  @param {Boolean|Function} [option.onInput=true] 监听输入框输入事件@@@###监听输入框输入事件,若为true,则启用自动完成功能,若为false,则关闭,若为function,则用自定义方法
     *  @example
     * 
     *   html:
     *
            <input type="text" id="userChooseBox" />
     *      
     *   js: 
     *   
            // 初始化
            var uiUserChooseBox = wui.userChooseBox( "userChooseBox",{
            });
     *
     */
	ui.userChooseBox = function(id, options){

        var _pluginDataName = 'plugin_uiChooseBox',
            _widgetName = "userChooseBox";
        ...
        function _extendOpt(opt){
            ...
            var defaultSetting = {
                // {string} 非空,弹出页面URL
                popPageUrl: ui.commonPageBasePath + "wui.userChooseBox.popup.html"
                // {object} 默认选中数据
                , value: [] 
                // {String} 组件宽度,默认""
                , width: ""    
                ...
                , gridUrl: ui.serviceInterface.userServiceAPI
         ...
         *  @example 
            ...
            // 单个节点添加出错时触发
            uiUserChooseBox.on("itemAddError", function(e){
         ...
         * @example 
            ...
            // 取消组件事件监听
            uiUserChooseBox.off("itemAddError");
        ...
        * @example  
            ...
            // 设置组件值
            uiUserChooseBox.set({"id" :"0cce8be5-d07e-e2b0-501a-44cb4d78b8be","name":"李文","sex":"男","age":"25","email":"15875354693@163.com"});
        ...
        * @example 
            ...
            // 获取组件值
            var value = uiUserChooseBox.get("value");   // "0cce8be5-d07e-e2b0-501a-44cb4d78b8be"
        ...
        * @example 
            ...
            // 设置组件值
            uiUserChooseBox.add({"id" :"0cce8be5-d07e-e2b0-501a-44cb4d78b8be","name":"李文","sex":"男","age":"25","email":"15875354693@163.com"});
        ...
        * @example 
            ...
            // 移除组件节点和值
            uiUserChooseBox.remove("0cce8be5-d07e-e2b0-501a-44cb4d78b8be");
        ...
        */
         ...
         * @example 
            // 重新初始化组件,若是传递参数，则
            var myUserChooseBox = uiUserChooseBox.init();
